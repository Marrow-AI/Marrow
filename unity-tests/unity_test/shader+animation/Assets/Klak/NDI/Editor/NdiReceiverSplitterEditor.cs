...
namespace Klak.Ndi
{
    ...
    [CustomEditor(typeof(NdiReceiverSplitter))]
    public sealed class NdiReceiverSplitterEditor : Editor
    {
        ...
        {
            foreach (NdiReceiverSplitter receiver in targets) receiver.RequestReconnect();
        }
